...
const inspectionstatus_labels = [
  "Completed",
  "Canceled",
  "Started",
  "Not Started",
];
const assettype_labels = [
  "Vessel",
  "Column",
  "Filter",
  "Exchanger",
...
const inspectionmethods_labels = [
  "VE",
  "VI",
  "UT",
  "AUT",
...
const insmethod_status_data = [
  {
    Inspection_Method: "Overal Inspection",
    Total_Required: "6",
    Completed: "5",
    Canceled: "6",
    Started: "6",
...
const overal_inspection = insmethod_status_data.find(
  (c) => c.Inspection_Method === "Overal Inspection"
);
...
export const VIStatus = (insmethod_status_data = insmethod_status_data) => {
